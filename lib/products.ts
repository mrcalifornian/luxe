...
export const products: Product[] = [
  ...
  },
  {
    ...
    price: 350,
    description: "A timeless trench coat designed with a double-breasted front and belted waist. Made from water-resistant cotton twill.",
    category: "Outerwear",
  ...
  },
  {
    ...
    price: 145,
    description: "Elegant and versatile pleated midi skirt. The lightweight fabric ensures graceful movement with every step.",
    category: "Bottoms",
  ...
  },
  {
    ...
    price: 210,
    description: "Stay warm in this oversized chunky knit sweater made from 100% thick wool, perfect for chilly winter days.",
    category: "Knitwear",
  ...
  },
  {
    ...
    price: 185,
    description: "A versatile tailored wool vest. Can be worn seamlessly as a sleek standalone top or layered over your favorite blouses.",
    category: "Outerwear",
    image: "https://images.unsplash.com/photo-1594938328870-9623159c8c99?w=600&h=800&fit=crop",
    sizes: ["XS", "S", "M", "L", "XL"],
  },
  {
    id: "13",
    ...
    price: 155,
    description: "Your go-to casual layer. Crafted from organic cotton denim with classic styling and slight vintage fading.",
    category: "Outerwear",
    image: "https://images.unsplash.com/photo-1559551409-dadc959f76b8?w=600&h=800&fit=crop",
    sizes: ["XS", "S", "M", "L", "XL"],
  },
  {
    id: "14",
    ...
    price: 120,
    description: "A crisp cotton poplin blouse featuring a stylish mandarin collar and voluminous sleeves for a touch of drama.",
    category: "Tops",
  ...
  },
  {
    ...
    price: 135,
    description: "Breezy and comfortable wide-leg pants crafted from pure linen. Ideal for warm weather styling.",
    category: "Bottoms",
  ...
  },
  {
    ...
    price: 245,
    description: "A flattering wrap maxi dress with a deep V-neckline and a flowing skirt, suitable for special occasions.",
    category: "Dresses",
  ...
  },
  {
    ...
    price: 160,
    description: "A sleek, form-fitting ribbed sweater with a cozy turtleneck. The excellent layering base for cold days.",
    category: "Knitwear",
  ...
  },
  {
    ...
    name: "Satin Camisole",
    price: 85,
    description: "Silky satin camisole with a delicate lace trim along the V-neck. Beautiful under a blazer or on its own.",
    category: "Tops",
  ...
  },
  {
    ...
    price: 220,
    description: "Edgy vegan leather moto jacket featuring asymmetrical zip closure, metallic hardware, and a cropped fit.",
    category: "Outerwear",
  ...
  },
  {
    ...
    price: 140,
    originalPrice: 180,
    description: "Classic straight-leg jeans with a timeless high-rise fit. Designed in a versatile mid-blue wash.",
    category: "Bottoms",
  ...
  },
  {
    ...
    price: 295,
    description: "A minimalist leather crossbody bag with subtle gold hardware and enough space for your daily essentials.",
  ...
  },
  {
    ...
    price: 95,
    description: "Luxurious square silk scarf featuring a timeless geometric print. Tie it around your neck or your favorite tote.",
    category: "Accessories",
  ...
  },
  {
    ...
    price: 185,
    description: "Chic oversized sunglasses crafted from high-quality acetate, offering full UV protection.",
    category: "Accessories",
  ...
  },
  {
    ...
    price: 45,
    description: "A casual, unstructured cotton baseball cap with an adjustable back strap and a subtle embroidered logo.",
    category: "Accessories",
  ...
  },
  {
    ...
    price: 275,
    description: "Sleek leather ankle boots with a comfortable block heel and a modern pointed toe. Handcrafted perfectly.",
    category: "Shoes",
  ...
  },
  {
    ...
    price: 165,
    description: "Clean, white leather sneakers that pair perfectly with everything from jeans to tailored trousers.",
    category: "Shoes",
  ...
  },
  {
    ...
    price: 65,
    description: "A beautifully braided genuine leather belt, perfect for adding texture and waist definition to any outfit.",
    category: "Accessories",
  ...
  },
  {
    ...
    price: 195,
    originalPrice: 240,
    description: "Classic slip-on loafers crafted from soft suede, featuring a traditionally refined silhouette and cushioned insoles.",
    category: "Shoes",
    image: "https://images.unsplash.com/photo-1527010154944-f2241763d806?w=600&h=800&fit=crop",
    sizes: ["6", "7", "8", "9", "10"],
  },
  {
    id: "29",
    ...
    price: 110,
    description: "Timeless chunky hoop earrings finished in 18k gold plating. Lightweight enough for daily wear.",
    category: "Accessories",
  ...
  },
  {
    ...
    price: 85,
    description: "Stay incredibly cozy with this ultra-soft ribbed cashmere beanie. A luxurious necessity for colder climates.",
    category: "Accessories",
